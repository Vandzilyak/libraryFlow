...
import ua.java.springLibrary.enums.SearchType;
...
public class Utils {
    ...
    private SearchType selectedSearchType = SearchType.TITLE; // значення по замовчуванню

    @Autowired
    private MessageSource msg;

    private Character[] letters = new Character[]{'А', 'Б', 'В', 'Г', 'Д', 'Е', 'Ё', 'Ж', 'З', 'И', 'Й', 'К', 'Л', 'М', 'Н', 'О', 'П',
